...
use_ff = true;
if strcmp(cntrl_type, 'const-sig')
  gam_rob = 46.4;
elseif strcmp(cntrl_type, 'choose-zeta')
  gam_rob = 25;
else
  error('unrecognized exp_id_str: %s', cntrl_type)
end
% ------- Load Plants -----
...
xdir_cntrl = get_xdir_standard_control(cntrl_type, gam_rob);
