...
root = '/media/labserver/afm-cs/sysID/PSD/01-16-2019';
root_nb = '/media/labserver/afm-cs/sysID/PSD/01-16-2019';

fname_ext_psd = 'z_PSD_xyon_bungee_extfan3.json';
fname_int_psd = 'z_PSD_xyon_bungee_intfan3.json';
fname_nobung_psd = 'z_PSD_xyon_nobungee.json';
...
fname_ext_tm = 'z_PSD_xyon_bungee_extfan3_time.json';
fname_int_tm = 'z_PSD_xyon_bungee_intfan3_time.json';
fname_nobung_tm = 'z_PSD_xyon_nobungee_time.json';
