...
'raster_scan_512pix_5mic_02Hz_out_3-19-2019-01.csv',...
'raster_scan_512pix_5mic_04Hz_out_3-19-2019-01.csv',...
'raster_scan_512pix_5mic_06Hz_out_3-19-2019-01.csv',...
...
'cs-traj-512pix-10perc-500nm-5mic-02Hz-250prescan-isconnect_out_3-19-2019-01.csv',...
...
% rast_exps = rast_exps([7, 1,2, 3,4,5,6])
...
%%
x1s = [67, 27, 33, 38, 42, 45, 44, 44];
x2s = [481, 494, 499, 499, 454, 459, 459];
figbase = 10;
