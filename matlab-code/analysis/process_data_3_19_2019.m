...
raster_files = {...
'raster_scan_512pix_5mic_5.00e-01Hz_out_3-19-2019-01.csv',...
'raster_scan_512pix_5mic_01Hz_out_3-19-2019-01.csv',...
'raster_scan_512pix_5mic_04Hz_out_3-19-2019-01.csv',...
'raster_scan_512pix_5mic_05Hz_out_3-19-2019-01.csv',...
'raster_scan_512pix_5mic_08Hz_out_3-19-2019-01.csv',...
'raster_scan_512pix_5mic_10Hz_out_3-19-2019-01.csv',...
};
cs_files = {...
'cs-traj-512pix-10perc-500nm-5mic-01Hz-250prescan-notconnect_out_3-19-2019-01.csv',...
'cs-traj-512pix-10perc-500nm-5mic-02Hz-250prescan-notconnect_out_3-19-2019-01.csv',...
'cs-traj-512pix-10perc-500nm-5mic-04Hz-250prescan-notconnect_out_3-19-2019-01.csv',...
'cs-traj-512pix-10perc-500nm-5mic-05Hz-250prescan-notconnect_out_3-19-2019-01.csv',...
'cs-traj-512pix-15perc-500nm-5mic-01Hz-250prescan-notconnect_out_3-19-2019-01.csv',...
'cs-traj-512pix-15perc-500nm-5mic-02Hz-250prescan-notconnect_out_3-19-2019-01.csv',...
'cs-traj-512pix-15perc-500nm-5mic-04Hz-250prescan-notconnect_out_3-19-2019-01.csv',...
'cs-traj-512pix-15perc-500nm-5mic-05Hz-250prescan-notconnect_out_3-19-2019-01.csv',...
};
...
%%
x1s = [39, 47, 53, 51, 50, 51];
x2s = [499, 465, 464, 468, 464, 465];
figbase = 10;
...
slice = 25:512-25;
master_idx = 1;
im_master = pixmats{master_idx} - mean(pixmats{master_idx}(:));
if ~isinf(mu)
