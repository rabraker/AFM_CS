...
% File name
% InputFileName = 'z-axis_sines_info_intsamps.json';
InputFileName = 'z-axis_sines_info_quick_firstRes.json';
...
freq2 = [];
freq2 = logspace(log10(180), log10(240), 50)';
freq3 = []; %linspace(240, 2000, 100)';
freq4 = []; %linspace(2000, 2500, 50);
freq4 = []; %linspace(2600, (12500-1), 100)';
...
freqs_Hz = [freq0; freq1; freq2; freq3; freq4];

M_s = ones(length(freqs_Hz), 1)*10;
