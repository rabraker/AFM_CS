...
% File name
InputFileName = 'ALL-axis_sines_info_intsamps_quick.json';
...
% freq0 = [];
freq1 = linspace(1, 185, 20)';
freq10 = linspace(190, 235, 20)';
freq2 = linspace(201, 1200, 100)';
freq3 = logspace(log10(1200), log10(12500-1), 66)';

freqs_Hz = [freq10; freq1; freq2; freq3];
