% bp_im = bp_reconstruct(I_sampled, pixelifsampled)
%
% Reconstruct the sampled image I_sampled using basis pursuit. 
% 

function bp_im = bp_reconstruct(I_sampled, pixelifsampled)
