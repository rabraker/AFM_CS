function ydirControl = get_ydir_standard_control()
...
[Sens, Hy_rprime, Hyr, Loop] = tf_loops(Gy, D_ki * Dy, 1, Dy_ff);

ydirControl = struct('Sens', Sens,...
  'Hyr', Hyr,...
  'Hy_rprime', Hy_rprime,...
  'Loop', Loop,...
  'G', Gy,...
  ...
  'D', Dy,...
  'D_ff', make_dy_ff(),...
  'D1_loop', zpk([], [], 1, AFM.Ts),...
  'D2_ss_ff', zpk([], [], 1, AFM.Ts));
