...
% direction       --- the direction of the \mu path, 1 means it is a continuous scanning pattern, 2 means from left to right, ...
%                     3 means from right to left, 4 means from top to bottom, 5 means from bottom to top
