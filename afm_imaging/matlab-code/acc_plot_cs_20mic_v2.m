...
cs_name_s{1} = 'cs-traj-512pix-3perc-2000nm-20mic-01Hz_out_9-23-2017-01.csv';
cs_name_s{2} = 'cs-traj-512pix-10perc-2000nm-20mic-01Hz_out_9-23-2017-01.csv';
cs_name_s{3} = 'cs-traj-512pix-15perc-2000nm-20mic-01Hz_out_9-23-2017-02.csv';
...
%%
fig_path = fullfile(getfigroot, '20micron_csscans_v2.eps');
