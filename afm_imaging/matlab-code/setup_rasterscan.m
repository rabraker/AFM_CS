...
y_height = (number_of_lines/square_num_lines)*image_side

time_total = number_of_lines*x_period;

[x_rasterdata, truefreq, points_per_line] = raster(x_freq, Ts, time_total, 'coerce', 1,...
                            'shift', -x_period/4);
...
xy_data = zeros(length(2*x_rasterdata.Time), 1);
j = 1;
...
%%
data_in_path = 'C:\Users\arnold\Documents\labview\afm_imaging\data\data-in.csv';
